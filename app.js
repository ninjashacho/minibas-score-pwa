...
const DEFAULT_DB = { games: [], currentGameId: null };
...
function newGame() {
  return {
    ...
    teams: {
      A: { name: 'Aチーム', coach: '', assistant: '', players: [] },
      B: { name: 'Bチーム', coach: '', assistant: '', players: [] }
    },
    quarter: 1,                   // 1-4, 5+はOT
...
function renderHome() {
  ...
  return `
    <div class="header"><h1>ミニバス得点表</h1>
      <button class="btn green" data-act="new">＋新規試合</button></div>
    <div class="container">
      <div class="card">
...
function renderSetup() {
  ...
  return `
    ...
    <div class="container">
      ...
      ${['A','B'].map(t => `
        <div class="card">
          <h3 style="margin-top:0">${t}チーム</h3>
